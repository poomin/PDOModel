...
!function (a) {
    ...
    be.extend(be.FE.POPUP_TEMPLATES, {
        ...
        imageUpload: !0,
        imageUploadURL: "../froala/upload_froala.php",
        ...
        var g, l, f, d, o, a, t = !1, i = 1, c = 2, u = 3, m = 4, n = 5, h = 6, v = 8, r = {};
        ...
        function w(e) {
            void 0 === e && (e = !0);
            var t, a = Array.prototype.slice.call(p.el.querySelectorAll("img")), i = [];
            for (t = 0; t < a.length; t++)if (i.push(a[t].getAttribute("src")), be(a[t]).toggleClass("fr-draggable", p.opts.imageMove), "" === a[t].getAttribute("class") && a[t].removeAttribute("class"), "" === a[t].getAttribute("style") && a[t].removeAttribute("style"), a[t].parentNode && a[t].parentNode.parentNode && p.node.hasClass(a[t].parentNode.parentNode, "fr-img-caption")) {
            ...
            if (o)for (t = 0; t < o.length; t++)i.indexOf(o[t].getAttribute("src")) < 0 && p.events.trigger("image.removed", [be(o[t])]);
            if (o && e) {
                var n = [];
        ...
        function E() {
            ...
            var t = e.scrollTop() - ("static" != e.css("position") ? e.offset().top : 0), a = e.scrollLeft() - ("static" != e.css("position") ? e.offset().left : 0);
        ...
        function R(e) {
            ...
            if ("mousedown" == e.type) {
                var a = p.$oel.get(0).ownerDocument, i = a.defaultView || a.parentWindow, r = !1;
                try {
        ...
        function x(e, t, a) {
            ...
            }(p.language.translate("Something went wrong. Please try again.")), !g && a && Q(a), p.events.trigger("image.error", [{
                code: e,
                message: r[e]
            }, t, a])
        }
        ...
        function O(e) {
            ...
            try {
                if (p.opts.imageUploadToS3)if (201 == t) {
                    var s = function (e) {
                        try {
                    ...
                    s && P(s, !1, [], e, a || i)
                } else x(m, a || i, e); else if (200 <= t && t < 300) {
                    var n = function (e) {
                        try {
        ...
        function z(e, t) {
            if (void 0 !== e && 0 < e.length) {
                ...
                if (p.drag_support.formdata && (a = p.drag_support.formdata ? new FormData : null), a) {
                    ...
                    p.opts.imageUploadToS3 && (s = p.opts.imageUploadToS3.uploadURL ? p.opts.imageUploadToS3.uploadURL : "https://" + p.opts.imageUploadToS3.region + ".amazonaws.com/" + p.opts.imageUploadToS3.bucket), function (t, a, e, r) {
                        function s() {
                            var e = be(this);
        ...
        function W(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (a && a.type && -1 !== a.type.indexOf("image") && 0 <= p.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, ""))) {
                    ...
                    var r = e.originalEvent.pageX, s = e.originalEvent.pageY;
        ...
        function K(e) {
            ...
            var i = p.opts.imageInsertButtons.indexOf("imageUpload"), r = p.opts.imageInsertButtons.indexOf("imageByURL"), s = "";
        ...
        function ee(e) {
            ...
            z([new Blob([new Uint8Array(a)], {type: be(e).attr("src").split(",")[0].replace(/data\:/g, "").replace(/;base64/g, "")})], g)
        }
        ...
        function te() {
            p.opts.imagePaste ? p.$el.find("img[data-fr-image-pasted]").each(function (e, a) {
                    ...
                    if (0 === a.src.indexOf("data:")) ee(a); else if (0 === a.src.indexOf("blob:") || 0 === a.src.indexOf("http") && p.opts.imageUploadRemoteUrls && p.opts.imageCORSProxy) {
                        var i = new Image;
                        i.crossOrigin = "Anonymous", i.onload = function () {
                            var e = p.o_doc.createElement("CANVAS"), t = e.getContext("2d");
        ...
        function ae(e) {
            var t = e.target.result, a = p.opts.imageDefaultWidth;
        ...
        function ie(e) {
            if (e && e.clipboardData && e.clipboardData.items) {
                var t = null;
                if (e.clipboardData.getData("text/html") || e.clipboardData.getData("text/rtf")) t = e.clipboardData.items[0].getAsFile(); else for (var a = 0; a < e.clipboardData.items.length && !(t = e.clipboardData.items[a].getAsFile()); a++);
        ...
        return {
            _init: function () {
                ...
                p.events.$on(p.$el, p._mousedown, "IMG" == p.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
                    ...
                    if (e.shiftKey && "" === p.selection.text().replace(/\n/g, "") && p.keys.isArrow(e.which)) {
                        var t = p.selection.element(), a = p.selection.endElement();
            ...
            showInsertPopup: function () {
                var e = p.$tb.find('.fr-command[data-cmd="insertImage"]'), t = p.popups.get("image.insert");
                if (t || (t = K()), I(), !t.hasClass("fr-active"))if (p.popups.refresh("image.insert"), p.popups.setContainer("image.insert", p.$tb), e.is(":visible")) {
                    var a = e.offset().left + e.outerWidth() / 2, i = e.offset().top + (p.opts.toolbarBottom ? 10 : e.outerHeight() - 10);
            ...
            insertByURL: function () {
                ...
                if (0 < e.val().length) {
                    ...
                    if (p.opts.imageUploadRemoteUrls && p.opts.imageCORSProxy && p.opts.imageUpload) {
                        ...
                        a.onload = function () {
                            200 == this.status ? z([new Blob([this.response], {type: this.response.type || "image/png"})], g) : x(i)
                        }, a.onerror = function () {
                            P(t, !0, [], g)
