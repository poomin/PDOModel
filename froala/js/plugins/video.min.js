...
!function (i) {
    ...
    G.extend(G.FE.POPUP_TEMPLATES, {
        ...
        videoUploadURL: "../froala/upload_froala.php",

    }), G.FE.VIDEO_PROVIDERS = [{
        ...
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vidyard"
    }], G.FE.VIDEO_EMBED_REGEX = /^\W*((<iframe.*><\/iframe>)|(<embed.*>))\W*$/i, G.FE.PLUGINS.video = function (v) {
        var a, f, p, u, o, i, d = 2, l = 3, c = 4, h = 5, g = 6, r = {};
        ...
        function s() {
            ...
            if (e || (e = function () {
                    ...
                    if (0 < v.opts.videoEditButtons.length) {
                        e += '<div class="fr-buttons">', e += v.button.buildList(v.opts.videoEditButtons);
                        var t = {buttons: e += "</div>"}, i = v.popups.create("video.edit", t);
                        return v.events.$on(v.$wp, "scroll.video-edit", function () {
                            u && v.popups.isVisible("video.edit") && (v.events.disableBlur(), A(u))
                        }), i
                    }
                    return !1
                }()), e) {
                v.popups.setContainer("video.edit", v.$sc), v.popups.refresh("video.edit");
                var t = u.find("iframe, embed, video"), i = t.offset().left + t.outerWidth() / 2, o = t.offset().top + t.outerHeight();
                v.popups.show("video.edit", i, o, t.outerHeight())
            }
        }

        function n(e) {
            if (e)return v.popups.onRefresh("video.insert", m), v.popups.onHide("image.insert", K), !0;
            var t = "";
            ...
            var i, o = "", r = v.opts.videoInsertButtons.indexOf("videoUpload"), s = v.opts.videoInsertButtons.indexOf("videoByURL"), n = v.opts.videoInsertButtons.indexOf("videoEmbed");
            ...
            return function (o) {
                v.events.$on(o, "dragover dragenter", ".fr-video-upload-layer", function () {
                    return G(this).addClass("fr-drop"), !1
                }, !0), v.events.$on(o, "dragleave dragend", ".fr-video-upload-layer", function () {
                    return G(this).removeClass("fr-drop"), !1
                }, !0), v.events.$on(o, "drop", ".fr-video-upload-layer", function (e) {
                    e.preventDefault(), e.stopPropagation(), G(this).removeClass("fr-drop");
        ...
        function b(e) {
            ...
            var t = !1;
            u && (X(), t = !0), v.html.insert('<span contenteditable="false" draggable="true" class="fr-jiv fr-video">' + e + "</span>", !1, v.opts.videoSplitHTML), v.popups.hide("video.insert");
            var i = v.$el.find(".fr-jiv");
            i.removeClass("fr-jiv"), W(i, v.opts.videoDefaultDisplay, v.opts.videoDefaultAlign), i.toggleClass("fr-draggable", v.opts.videoMove), v.events.trigger(t ? "video.replaced" : "video.inserted", [i])
        }

        function y() {
            var e = G(this);
            v.popups.hide("video.insert"), e.removeClass("fr-uploading"), e.parent().next().is("br") && e.parent().next().remove(), A(e.parent()), v.events.trigger("video.loaded", [e.parent()])
        }

        function E(a, e, d, l, f) {
            v.edit.off(), _("Loading video"), e && (a = v.helpers.sanitizeURL(a));
            w("Loading video"), function () {
                var e, t;
                if (l) {
                    v.undo.canDo() || l.find("video").hasClass("fr-uploading") || v.undo.saveStep();
                    var i = l.find("video").data("fr-old-src"), o = l.data("fr-replaced");
                    ...
                    e.find("video").on("canplay", y), e.find("video").attr("src", a), v.edit.on(), k(), v.undo.saveStep(), v.$el.blur(), v.events.trigger(o ? "video.replaced" : "video.inserted", [e, f])
                } else e = function (e, t, i) {
                    var o, r = "";
                    if (t && void 0 !== t)for (o in t)t.hasOwnProperty(o) && "link" != o && (r += " data-" + o + '="' + t[o] + '"');
                    var s = v.opts.videoDefaultWidth;
                    s && "auto" != s && (s += "px");
                    var n = G('<span contenteditable="false" draggable="true" class="fr-video fr-dv' + v.opts.videoDefaultDisplay[0] + ("center" != v.opts.videoDefaultAlign ? " fr-fv" + v.opts.videoDefaultAlign[0] : "") + '"><video src="' + e + '" ' + r + (s ? ' style="width: ' + s + ';" ' : "") + " controls>" + v.language.translate("Your browser does not support HTML5 video.") + "</video></span>");
                ...
                }(a, d, y), k(), v.undo.saveStep(), v.events.trigger("video.inserted", [e, f])
            }()
        }
        ...
        function w(e) {
            ...
            if (t || (t = n()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-video-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), u) {
                ...
                var o = i.offset().left + i.width() / 2, r = i.offset().top + i.height();
        ...
        function x(e) {
            _("Loading video");
            var t = this.status, i = this.response, o = this.responseXML, r = this.responseText;
            try {
                if (v.opts.videoUploadToS3)if (201 == t) {
                    var s = function (e) {
                        try {
                            var t = G(e).find("Location").text(), i = G(e).find("Key").text();
        ...
        function S() {
            M(c, this.response || this.responseText || this.responseXML)
        }
        ...
        function U(e) {
            ...
            var t = e.pageX || (e.originalEvent.touches ? e.originalEvent.touches[0].pageX : null), i = e.pageY || (e.originalEvent.touches ? e.originalEvent.touches[0].pageY : null);
            if (!t || !i)return !1;
            if ("mousedown" == e.type) {
                var o = v.$oel.get(0).ownerDocument, r = o.defaultView || o.parentWindow, s = !1;
                try {
                    s = r.location != r.parent.location && !(r.$ && r.$.FE)
                } catch (n) {
                }
                s && r.frameElement && (t += v.helpers.getPX(G(r.frameElement).offset().left) + r.frameElement.clientLeft, i = e.clientY + v.helpers.getPX(G(r.frameElement).offset().top) + r.frameElement.clientTop)
            }
            v.undo.canDo() || v.undo.saveStep(), (f = G(this)).data("start-x", t), f.data("start-y", i), a.show(), v.popups.hideAll(), L()
        }
        ...
        function I(e) {
            ...
            if (f) {
                ...
                var t = e.pageX || (e.originalEvent.touches ? e.originalEvent.touches[0].pageX : null), i = e.pageY || (e.originalEvent.touches ? e.originalEvent.touches[0].pageY : null);
                if (!t || !i)return !1;
                var o = f.data("start-x"), r = f.data("start-y");
                f.data("start-x", t), f.data("start-y", i);
                var s = t - o, n = i - r, a = u.find("iframe, embed, video"), d = a.width(), l = a.height();
                (f.hasClass("fr-hnw") || f.hasClass("fr-hsw")) && (s = 0 - s), (f.hasClass("fr-hnw") || f.hasClass("fr-hne")) && (n = 0 - n), a.css("width", d + s), a.css("height", l + n), a.removeAttr("width"), a.removeAttr("height"), F()
            }
        }

        function $(e) {
            if (!v.core.sameInstance(p))return !0;
            f && u && (e && e.stopPropagation(), f = null, a.hide(), F(), s(), v.undo.saveStep())
        }
        ...
        function B(e, t, i, o) {
            return e.pageX = t, e.pageY = t, U.call(this, e), e.pageX = e.pageX + i * Math.floor(Math.pow(1.1, o)), e.pageY = e.pageY + i * Math.floor(Math.pow(1.1, o)), I.call(this, e), $.call(this, e), ++o
        }

        function k() {
            var e, t = Array.prototype.slice.call(v.el.querySelectorAll("video, .fr-video > *")), i = [];
            for (e = 0; e < t.length; e++)i.push(t[e].getAttribute("src")), G(t[e]).toggleClass("fr-draggable", v.opts.videoMove), "" === t[e].getAttribute("class") && t[e].removeAttribute("class"), "" === t[e].getAttribute("style") && t[e].removeAttribute("style");
            if (o)for (e = 0; e < o.length; e++)i.indexOf(o[e].getAttribute("src")) < 0 && v.events.trigger("video.removed", [G(o[e])]);
            o = t
        }
        ...
        function F() {
            p || function () {
                ...
                if (v.shared.$video_resizer ? (p = v.shared.$video_resizer, a = v.shared.$vid_overlay, v.events.on("destroy", function () {
                            p.removeClass("fr-active").appendTo(G("body:first"))
                        }, !0)) : (v.shared.$video_resizer = G('<div class="fr-video-resizer"></div>'), p = v.shared.$video_resizer, v.events.$on(p, "mousedown", function (e) {
                            e.stopPropagation()
                        }, !0), v.opts.videoResize && (p.append(t("nw") + t("ne") + t("sw") + t("se")), v.shared.$vid_overlay = G('<div class="fr-video-overlay"></div>'), a = v.shared.$vid_overlay, e = p.get(0).ownerDocument, G(e).find("body:first").append(a))), v.events.on("shared.destroy", function () {
                        p.html("").removeData().remove(), p = null, v.opts.videoResize && (a.remove(), a = null)
                    }, !0), v.helpers.isMobile() || v.events.$on(G(v.o_win), "resize.video", function () {
                        z(!0)
                    }), v.opts.videoResize) {
                    e = p.get(0).ownerDocument, v.events.$on(p, v._mousedown, ".fr-handler", U), v.events.$on(G(e), v._mousemove, I), v.events.$on(G(e.defaultView || e.parentWindow), v._mouseup, $), v.events.$on(a, "mouseleave", $);
                    var o = 1, r = null, s = 0;
                    v.events.on("keydown", function (e) {
                        if (u) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey, i = e.which;
                            (i !== r || 200 < e.timeStamp - s) && (o = 1), (i == G.FE.KEYCODE.EQUALS || v.browser.mozilla && i == G.FE.KEYCODE.FF_EQUALS) && t && !e.altKey ? o = B.call(this, e, 1, 1, o) : (i == G.FE.KEYCODE.HYPHEN || v.browser.mozilla && i == G.FE.KEYCODE.FF_HYPHEN) && t && !e.altKey && (o = B.call(this, e, 2, -1, o)), r = i, s = e.timeStamp
                        }
        ...
        function O(e) {
            ...
            for (var t = 0; t < G.FE.INSTANCES.length; t++)G.FE.INSTANCES[t] != v && G.FE.INSTANCES[t].events.trigger("video.hideResizer");
            v.toolbar.disable(), v.helpers.isMobile() && (v.events.disableBlur(), v.$el.blur(), v.events.enableBlur()), v.$el.find(".fr-video.fr-active").removeClass("fr-active"), (u = G(this)).addClass("fr-active"), v.opts.iframe && v.size.syncIframe(), q(), F(), s(), v.selection.clear(), v.button.bulkRefresh(), v.events.trigger("image.hideResizer")
        }

        function z(e) {
            u && (v.shared.vid_exit_flag || !0 === e) && (p.removeClass("fr-active"), v.toolbar.enable(), u.removeClass("fr-active"), u = null, L())
        }
        ...
        function P(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (i && i.type && -1 !== i.type.indexOf("video")) {
                    ...
                    v.markers.remove(), v.markers.insertAtPoint(e.originalEvent), v.$el.find(".fr-marker").replaceWith(G.FE.MARKERS), v.popups.hideAll();
                    var o = v.popups.get("video.insert");
                    return o || (o = n()), v.popups.setContainer("video.insert", v.$sc), v.popups.show("video.insert", e.originalEvent.pageX, e.originalEvent.pageY), w(), 0 <= v.opts.videoAllowedTypes.indexOf(i.type.replace(/video\//g, "")) ? T(t.files) : M(g), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }
        ...
        function T(e) {
            if (void 0 !== e && 0 < e.length) {
                ...
                var t, i = e[0];
                if (i.size > v.opts.videoMaxSize)return M(h), !1;
                if (v.opts.videoAllowedTypes.indexOf(i.type.replace(/video\//g, "")) < 0)return M(g), !1;
                if (v.drag_support.formdata && (t = v.drag_support.formdata ? new FormData : null), t) {
                    ...
                    s.onload = function () {
                        x.call(s, u)
                    }, s.onerror = S, s.upload.onprogress = R, s.onabort = D, w(), v.events.disableBlur(), v.edit.off(), v.events.enableBlur();
        ...
        function N() {
            if (u) {
                var e = v.popups.get("video.size"), t = u.find("iframe, embed, video");
        ...
        function V(e) {
            if (e)return v.popups.onRefresh("video.size", N), !0;
            var t = {
            ...
            return v.events.$on(v.$wp, "scroll", function () {
                u && v.popups.isVisible("video.size") && (v.events.disableBlur(), A(u))
            }), i
        }
        ...
        function W(e, t, i) {
            !v.opts.htmlUntouched && v.opts.useClasses ? (e.removeClass("fr-fvl fr-fvr fr-dvb fr-dvi"), e.addClass("fr-fv" + i[0] + " fr-dv" + t[0])) : "inline" == t ? (e.css({display: "inline-block"}), "center" == i ? e.css({"float": "none"}) : "left" == i ? e.css({"float": "left"}) : e.css({"float": "right"})) : (e.css({
                        display: "block",
                        clear: "both"
                    }), "left" == i ? e.css({textAlign: "left"}) : "right" == i ? e.css({textAlign: "right"}) : e.css({textAlign: "center"}))
        }

        function j() {
            v.$el.find("video").filter(function () {
                return 0 === G(this).parents("span.fr-video").length
            }).wrap('<span class="fr-video" contenteditable="false"></span>'), v.$el.find("embed, iframe").filter(function () {
                if (v.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < G(this).parents("span.fr-video").length)return !1;
                for (var e = G(this).attr("src"), t = 0; t < G.FE.VIDEO_PROVIDERS.length; t++) {
                    var i = G.FE.VIDEO_PROVIDERS[t];
                    if (i.test_regex.test(e) && new RegExp(v.opts.videoAllowedProviders.join("|")).test(i.provider))return !0
                }
                return !1
            }).map(function () {
                return 0 === G(this).parents("object").length ? this : G(this).parents("object").get(0)
            }).wrap('<span class="fr-video" contenteditable="false"></span>');
            for (var e, t, i = v.$el.find("span.fr-video, video"), o = 0; o < i.length; o++) {
                var r = G(i[o]);
                !v.opts.htmlUntouched && v.opts.useClasses ? ((t = r).hasClass("fr-dvi") || t.hasClass("fr-dvb") || (t.addClass("fr-fv" + Y(t)[0]), t.addClass("fr-dv" + H(t)[0])), v.opts.videoTextNear || r.removeClass("fr-dvi").addClass("fr-dvb")) : v.opts.htmlUntouched || v.opts.useClasses || (W(e = r, e.hasClass("fr-dvb") ? "block" : e.hasClass("fr-dvi") ? "inline" : null, e.hasClass("fr-fvl") ? "left" : e.hasClass("fr-fvr") ? "right" : Y(e)), e.removeClass("fr-dvb fr-dvi fr-fvr fr-fvl"))
            }
        ...
        return r[1] = "Video cannot be loaded from the passed link.", r[d] = "No link in upload response.", r[l] = "Error during file upload.", r[c] = "Parsing response failed.", r[h] = "File is too large.", r[g] = "Video file type is invalid.", r[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", v.shared.vid_exit_flag = !1, {
            _init: function () {
                v.events.on("drop", P, !0), v.events.on("mousedown window.mousedown", e), v.events.on("window.touchmove", L), v.events.on("mouseup window.mouseup", z), v.events.on("commands.mousedown", function (e) {
                    ...
                    i = !0
                })), v.events.on("html.set", j), j(), v.events.$on(v.$el, "mousedown", "span.fr-video", function (e) {
                    e.stopPropagation()
                }), v.events.$on(v.$el, "click touchend", "span.fr-video", function (e) {
                    if ("false" == G(this).parents("[contenteditable]:not(.fr-element):not(.fr-img-caption):not(body):first").attr("contenteditable"))return !0;
                    O.call(this, e)
                }), v.events.on("keydown", function (e) {
                    var t = e.which;
                    return !u || t != G.FE.KEYCODE.BACKSPACE && t != G.FE.KEYCODE.DELETE ? u && t == G.FE.KEYCODE.ESC ? (z(!0), e.preventDefault(), !1) : u && t != G.FE.KEYCODE.F10 && !v.keys.isBrowserAction(e) ? (e.preventDefault(), !1) : void 0 : (e.preventDefault(), X(), v.undo.saveStep(), !1)
                ...
                }), v.$wp && (k(), v.events.on("contentChanged", k)), n(!0), V(!0)
            }, showInsertPopup: function () {
                var e = v.$tb.find('.fr-command[data-cmd="insertVideo"]'), t = v.popups.get("video.insert");
                if (t || (t = n()), C(), !t.hasClass("fr-active"))if (v.popups.refresh("video.insert"), v.popups.setContainer("video.insert", v.$tb), e.is(":visible")) {
                    var i = e.offset().left + e.outerWidth() / 2, o = e.offset().top + (v.opts.toolbarBottom ? 10 : e.outerHeight() - 10);
            ...
            }, upload: T, insertByURL: function (e) {
                void 0 === e && (e = (v.popups.get("video.insert").find('.fr-video-by-url-layer input[type="text"]').val() || "").trim());
                var t = null;
                if (/^http/.test(e) || (e = "https://" + e), v.helpers.isURL(e))for (var i = 0; i < G.FE.VIDEO_PROVIDERS.length; i++) {
                    var o = G.FE.VIDEO_PROVIDERS[i];
                ...
                t ? b(t) : v.events.trigger("video.linkError", [e])
            }, insertEmbed: function (e) {
                void 0 === e && (e = v.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""), 0 !== e.length && G.FE.VIDEO_EMBED_REGEX.test(e) ? b(e) : v.events.trigger("video.codeError", [e])
            }, insert: b, align: function (e) {
                u.removeClass("fr-fvr fr-fvl"), !v.opts.htmlUntouched && v.opts.useClasses ? "left" == e ? u.addClass("fr-fvl") : "right" == e && u.addClass("fr-fvr") : W(u, H(), e), q(), F(), s(), v.selection.clear()
            }, refreshAlign: function (e) {
                if (!u)return !1;
                e.find("> *:first").replaceWith(v.icon.create("video-align-" + Y()))
            }, refreshAlignOnShow: function (e, t) {
                u && t.find('.fr-command[data-param1="' + Y() + '"]').addClass("fr-active").attr("aria-selected", !0)
            }, display: function (e) {
                u.removeClass("fr-dvi fr-dvb"), !v.opts.htmlUntouched && v.opts.useClasses ? "inline" == e ? u.addClass("fr-dvi") : "block" == e && u.addClass("fr-dvb") : W(u, e, Y()), q(), F(), s(), v.selection.clear()
            }, refreshDisplayOnShow: function (e, t) {
                u && t.find('.fr-command[data-param1="' + H() + '"]').addClass("fr-active").attr("aria-selected", !0)
            }, remove: X, hideProgressBar: C, showSizePopup: function () {
                var e = v.popups.get("video.size");
                e || (e = V()), C(), v.popups.refresh("video.size"), v.popups.setContainer("video.size", v.$sc);
                var t = u.find("iframe, embed, video"), i = t.offset().left + t.width() / 2, o = t.offset().top + t.height();
                v.popups.show("video.size", i, o, t.height())
            }, replace: function () {
                var e = v.popups.get("video.insert");
                e || (e = n()), v.popups.isVisible("video.insert") || (C(), v.popups.refresh("video.insert"), v.popups.setContainer("video.insert", v.$sc));
                var t = u.offset().left + u.width() / 2, i = u.offset().top + u.height();
                ...
                if (u) {
                    var i = v.popups.get("video.size"), o = u.find("iframe, embed, video");
    ...
    }, G.FE.RegisterCommand("insertVideo", {
        title: "Insert Video",
        undo: !1,
        focus: !0,
        ...
        plugin: "video"
    }), G.FE.DefineIcon("insertVideo", {
        NAME: "video-camera",
        FA5NAME: "camera"
    }), G.FE.DefineIcon("videoByURL", {NAME: "link"}), G.FE.RegisterCommand("videoByURL", {
        title: "By URL",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), G.FE.DefineIcon("videoEmbed", {NAME: "code"}), G.FE.RegisterCommand("videoEmbed", {
        title: "Embedded Code",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), G.FE.DefineIcon("videoUpload", {NAME: "upload"}), G.FE.RegisterCommand("videoUpload", {
        title: "Upload Video",
        undo: !1,
        focus: !1,
        toggle: !0,
    ...
    }), G.FE.RegisterCommand("videoInsertByURL", {
        undo: !0, focus: !0, callback: function () {
            this.video.insertByURL()
        }
    }), G.FE.RegisterCommand("videoInsertEmbed", {
        undo: !0, focus: !0, callback: function () {
            this.video.insertEmbed()
        }
    }), G.FE.DefineIcon("videoDisplay", {NAME: "star"}), G.FE.RegisterCommand("videoDisplay", {
        title: "Display",
        type: "dropdown",
    ...
    }), G.FE.DefineIcon("video-align", {NAME: "align-left"}), G.FE.DefineIcon("video-align-left", {NAME: "align-left"}), G.FE.DefineIcon("video-align-right", {NAME: "align-right"}), G.FE.DefineIcon("video-align-center", {NAME: "align-justify"}), G.FE.DefineIcon("videoAlign", {NAME: "align-center"}), G.FE.RegisterCommand("videoAlign", {
        type: "dropdown",
        title: "Align",
        options: {left: "Align Left", center: "None", right: "Align Right"},
        html: function () {
            var e = '<ul class="fr-dropdown-list" role="presentation">', t = G.FE.COMMANDS.videoAlign.options;
    ...
    }), G.FE.DefineIcon("videoReplace", {NAME: "exchange"}), G.FE.RegisterCommand("videoReplace", {
        title: "Replace",
        undo: !1,
        focus: !1,
        popup: !0,
    ...
    }), G.FE.DefineIcon("videoRemove", {NAME: "trash"}), G.FE.RegisterCommand("videoRemove", {
        title: "Remove",
        callback: function () {
            this.video.remove()
        }
    }), G.FE.DefineIcon("videoSize", {NAME: "arrows-alt"}), G.FE.RegisterCommand("videoSize", {
        undo: !1,
        focus: !1,
        popup: !0,
        title: "Change Size",
    ...
    }), G.FE.DefineIcon("videoBack", {NAME: "arrow-left"}), G.FE.RegisterCommand("videoBack", {
        title: "Back",
        undo: !1,
        focus: !1,
        back: !0,
    ...
    }), G.FE.RegisterCommand("videoDismissError", {
        title: "OK", undo: !1, callback: function () {
            this.video.hideProgressBar(!0)
        }
    }), G.FE.RegisterCommand("videoSetSize", {
        undo: !0,
        focus: !1,
        title: "Update",
        refreshAfterCallback: !1,
